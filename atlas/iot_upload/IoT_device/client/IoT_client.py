...
class IotClient(threading.Thread):
    def __init__(self, client_cfg):
        ...
        self.__client = mqtt.Client(mqtt.CallbackAPIVersion.VERSION1,client_id="65acbf2ffb8177243a40af65_yaogui_0_0_2024012107", clean_session=True)
    ...
    def connect(self):
        ...
        # 设置用户名，密码
        self.__client.username_pw_set("65acbf2ffb8177243a40af65_yaogui", "1ad05105fa5e9b7ad531fcea1df3a683b1a3200498f75fcae3fa69e0d96e4682")
        # 连接至broker
